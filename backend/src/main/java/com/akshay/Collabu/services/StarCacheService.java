...
public class StarCacheService {
    ...
    public StarDTO toggleStarForRepositoryOfOwnerId(Long userId, String repoName, Long ownerId) {
    	
    	String ownerUsername = cacheService.getUsername(userId); 
    	
    	Long repositoryId = cacheService.getRepositoryId(ownerUsername + "-" + repoName);
